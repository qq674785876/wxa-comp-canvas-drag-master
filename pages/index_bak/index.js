...
Page({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '我的账户', 'src': '/assets/images/account.png' },
        { 'index': 1, 'menu': '信用卡', 'src': '/assets/images/card.png' },
        { 'index': 2, 'menu': '投资理财', 'src': '/assets/images/investment.png' },
        { 'index': 3, 'menu': '现金贷款', 'src': '/assets/images/loan.png' },
        { 'index': 4, 'menu': '特色服务', 'src': '/assets/images/service.png' },
        { 'index': 5, 'menu': '转账汇款', 'src': '/assets/images/transfer.png' }
      ]
    }
    // 绘制转盘
